...
/**
 * The interactive half of the leaderboard. Data arrives as a prop from the
 * server component — this file no longer fetches anything, so the numbers are
 * in the HTML on first paint instead of appearing a round trip later.
 */
